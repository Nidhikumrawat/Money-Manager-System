    ...
    <div className="card">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center justify-end gap-2">
          <button
            disabled={loading}
            className="card-btn bg-purple-100 text-purple-700 border border-purple-400 px-4 py-0.5 rounded-lg hover:bg-purple-300 transition-all shadow-md hover:shadow-lg"
            onClick={handleEmail}
          >
            {loading ? (
              <>
