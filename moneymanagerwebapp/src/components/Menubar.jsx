        ...
        <div className="flex items-center justify-between gap-5 bg-white border-b border-gray-200/50 backdrop-blur-[2px] py-4 px-4 sm:px-7 sticky top-0 z-30 ">
            ...
            <div className="relative" ref={dropdownRef}>
                <button
                    ...
                    className="flex items-center justify-center w-10 h-10 bg-gray-100 hover:bg-gray-200 rounded-full transition-colors duration-200 focus:outline-none focus:ring-2  foucs:ring-purple-800 foucs:ring-offset-2">
                    ...
                    <div className="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-lg border border-gray-200 py-1 z-50">
                        ...
                        <div className="px-4 py-3 border-b border-gray-100">
                            <div className="flex items-center gap-3">
                                <div className="flex items justify-center w-8 h-8 bg-gray-100 rounded-full">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-xs text-gray-500 trancate">{user?.email || "guest@example.com"}</p>
                                </div>
                            </div>
                        </div>
            ...
            {/* mobile side - menu button and title*/}
            {openSideMenu && (
